...
export default function StorefrontPage() {
  ...
  return (
    <div style={storeStyles} className="min-h-screen bg-[#FCF8F9] dark:bg-zinc-950 pb-24 text-slate-800 dark:text-zinc-100 transition-colors duration-200">
      ...
      {whatsappNumber && (
        <a
          href={`https://wa.me/${whatsappNumber.replace(/\D/g, '')}?text=${encodeURIComponent(`Olá! Estou na vitrine da loja ${storeName} e gostaria de tirar uma dúvida.`)}`}
          target="_blank"
          rel="noopener noreferrer"
          className="fixed bottom-6 right-6 z-40 bg-[#25D366] hover:bg-[#20BA5A] text-white p-3.5 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 active:scale-95 flex items-center justify-center group"
        ...
        >
          ...
          <span className="absolute right-16 scale-0 transition-all rounded bg-slate-900 px-3 py-1.5 text-xs text-white group-hover:scale-100 whitespace-nowrap shadow-xl font-bold dark:bg-zinc-800">
